...
import style from './sv.module.scss';
...
export const ScrollVelocity: React.FC<ScrollVelocityProps> = ({
	...
	parallaxClassName = style.parallax,
	scrollerClassName = style.scroller,
	parallaxStyle,
	scrollerStyle,
}) => {
	function VelocityText({
		...
		return (
			<div className={`${style.parallax} ${parallaxClassName}`} style={parallaxStyle}>
				<motion.div className={`${style.scroller} ${scrollerClassName}`} style={{ x, ...scrollerStyle }}>
					{spans}
				</motion.div>
			</div>
		);
